...
INSERT INTO PLACE_OF_SERVICE(GRP_ID, LABEL, COUNT, PERCENT, TOTAL_PAID)
    values  (1,'OUTPATIENT HOSPITAL',128360,21,18651531),
            (1,'OFFICE',339402,16,17979756),
            (1,'INPATIENT HOSPITAL',5681,11,2831836),
            (1,'INDEPENDANT LAB',28105,10,844455),
            (1,'EMERGENCY ROOM',10143,8,406860),
            (1,'AMBULANCE',4225,6,313953),
            (1,'INDEPENDANT CLINIC',1076,6,311192),
            (1,'NURSING FACILITY',945,5,117323),
            (1,'DENTIST',3076,4,59529)
            ;
